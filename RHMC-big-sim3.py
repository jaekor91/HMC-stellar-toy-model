...
gff2_list = scheduler(1/5.**2, 4., 1000)
beta_list = scheduler(1e-5, 1e-7, 1000)
gym = multi_gym(dt=0., Nsteps=0, g_xx=0.005, g_ff=25., g_ff2=0.)
...
gym.run_RHMC(q_model, f_pos=True, delta=1e-6, Niter = Niter, Nsteps=Nsteps, \
             dt = dt, save_traj=False, verbose=True, q_true = q_true, schedule_g_ff2=gff2_list, N_max = Nobjs_model, schedule_beta=beta_list)
